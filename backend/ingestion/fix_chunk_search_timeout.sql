...
ALTER FUNCTION public.match_chunks_in_docs(extensions.vector, text[], integer) SET statement_timeout = '30s';
ALTER FUNCTION public.match_chunks_summary(extensions.vector, integer) SET statement_timeout = '30s';
