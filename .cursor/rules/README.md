...
| **When implementing or designing** | `docs/BACKEND_PLAN.md` | Full architecture, DB design, ingestion phases, retrieval stages, API spec, build order. Read when writing or changing backend code. |

## Single source of truth

- **docs/BACKEND_PLAN.md** is the only long-form spec. All backend work must follow it.
